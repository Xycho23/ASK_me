...
<div class="game-container">
    <h1>Charades Game</h1>
    <p class="player-name">It's <?= $actor ?>'s turn to act and <?= $guesser ?>'s turn to guess!</p>
    ...
    <!-- Next Player Button -->
    <button class="next-button" onclick="window.location.href='charades_game.php'">Next Player</button>
